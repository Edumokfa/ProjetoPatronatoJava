...
CREATE TABLE SESSAOXPRATICANTE (
	...
	CONSTRAINT FK_SXP_REF_SESSAO FOREIGN KEY(SXP_COD_SESSAO) REFERENCES SESSAO(SES_ID),
...
CREATE TABLE SESSAOXFUNCIONARIO (
	...
	CONSTRAINT FK_SXF_REF_SESSAO FOREIGN KEY(SXF_COD_SESSAO) REFERENCES SESSAO(SES_ID),
...
CREATE TABLE SESSAOXMATERIAL (
	...
	CONSTRAINT FK_SXM_REF_SESSAO FOREIGN KEY(SXM_COD_SESSAO) REFERENCES SESSAO(SES_ID),
    CONSTRAINT FK_SXM_REF_MATERIAL FOREIGN KEY(SXM_COD_MATERIAL) REFERENCES MATERIAL(MAT_ID)
);

CREATE TABLE SESSAOXCAVALOXATIVIDADE (
	SXCA_ID INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,
    SXCA_COD_SESSAO INTEGER NOT NULL,
    SXCA_COD_ANIMAL INTEGER NOT NULL,
    SXCA_COD_ATIVIDADE INTEGER NOT NULL,
	CONSTRAINT FK_SXCA_REF_SESSAO FOREIGN KEY(SXCA_COD_SESSAO) REFERENCES SESSAO(SES_ID),
    CONSTRAINT FK_SXCA_REF_ANIMAL FOREIGN KEY(SXCA_COD_ANIMAL) REFERENCES ANIMAL(ANI_ID),
	CONSTRAINT FK_SXCA_ATIVIDADE FOREIGN KEY(SXCA_COD_ATIVIDADE) REFERENCES ATIVIDADE(ATV_ID)
);
